...
class GalleryImage extends StatefulWidget {
  final List<UploadedFileDetails> imageUrls;
...
// clear and build list
  void _buildItemsList(List<UploadedFileDetails> items) {
    galleryItems.clear();
    for (UploadedFileDetails item in items) {
      galleryItems.add(
        GalleryItemModel(
          id: item.url ?? "",
          imageUrl: item.url ?? "",
          index: items.indexOf(item),
          uploadedFileDetails: item
        ),
      );
    }
  }
